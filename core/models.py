...
class FeedbackData(models.Model):
    ...
    first_name = models.CharField("Primeiro Nome", max_length=100, null=True, blank=True)
    last_name = models.CharField("Último Nome", max_length=100, null=True, blank=True)
    club_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="feedbacks", editable=False, null=True, blank=True)
    ...
    def __str__(self):
        return '{} {} feedback'.format(self.first_name, self.last_name)