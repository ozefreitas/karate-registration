...
urlpatterns = [
    ...
    path('password_recovery/request/', views.RequestPasswordResetView.as_view(), name="request-password-reset"),
    ...
    path('current_season/', views.CurrentSeasonView.as_view(), name="current-season"),
    path('login/', views.CustomAuthToken.as_view(), name="user-login"),
    path('me/', views.UserDetailView.as_view(), name="user-detail"),
    path('logout/', views.LogoutView.as_view(), name="user-logout"),
    path('users/', views.UsersView.as_view(), name="users"),

    path('club_notifications/', views.NotificationsView.as_view(), name="notifications"),
]
